...
function initializeParse() {
	...
	//alert("???");
    Prayer = Parse.Object.extend("Prayer");
    queryPrayer = new Parse.Query(Prayer);
    toFind();
    //toSave();  
...
function toSave(){
     ...
     //alert("!!!");
		...
		savePrayer.set("count",1);
		savePrayer.increment("count");
